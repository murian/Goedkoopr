...
### Google Gemini
- Uses `gemini-2.5-pro` model (latest version)
- Advanced multimodal capabilities for receipt scanning
- Excellent image recognition and text extraction
- Improved accuracy for complex receipts
